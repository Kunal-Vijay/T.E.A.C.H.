...
from app.domain.interfaces import (
    IGeminiDoubtClient,
    IGeminiWorkflowClient,
    IQueueClient,
    IUnitOfWork,
)
from app.infrastructure.gemini.gemini_doubt_client import GeminiDoubtClient
...
def get_gemini_workflow_client() -> IGeminiWorkflowClient:
    return GeminiWorkflowClient()


def get_gemini_doubt_client() -> IGeminiDoubtClient:
    return GeminiDoubtClient()
...
def get_live_class_generation_service(
    ...
    gemini_workflow_client: IGeminiWorkflowClient = Depends(get_gemini_workflow_client),
) -> LiveClassGenerationService:
    return LiveClassGenerationService(unit_of_work, queue_client, gemini_workflow_client)
...
def get_doubt_session_service(
    unit_of_work: IUnitOfWork = Depends(get_unit_of_work),
    gemini_doubt_client: IGeminiDoubtClient = Depends(get_gemini_doubt_client),
