...
def main() -> int:
    ...
    checks = {
        ...
        "hints on i dont know": 'IF THE STUDENT SAYS "I DON\'T KNOW"' in prompt,
        "limits dont know hints": "simpler hint questions" in prompt,
        "final question dont know": "ON THE FINAL QUESTION" in prompt,
